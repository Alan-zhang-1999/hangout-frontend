        ...
        <el-col :span="4">
            <el-card style="width: 300px; height: 600px; color: #333">
                <div style="padding-bottom: 10px; border-bottom: 1px solid #ccc">
                  ...
                  Online users
                  <span style="font-size: 12px">（click icon to chat）</span>
                </div>
                <div style="padding: 10px 0" v-for="user in users" :key="user.email">
                    <span>{{ user.username }}</span>
                    <el-avatar :size="50" :src="circleUrl"  v-if="user.online" class="el-icon-share" style="margin-left: 10px; font-size: 16px; cursor: pointer"
                             @click="chooseChatUser(user);" url=""><ChatDotRound /></el-avatar>
                    <el-icon v-else class="el-icon-share" style="margin-left: 10px; font-size: 16px; cursor: pointer"
                             @click="chooseChatUser(user);" url=""><ChatRound /></el-icon>
                ...
                <div style="padding-bottom: 10px; border-bottom: 1px solid #ccc">
                  <el-avatar :size="30" :src="circleUrl" />
                  <span class="title">xxx</span>
                  Offline users<span style="font-size: 12px">（click icon to chat）</span></div>
                <div style="padding: 10px 0" v-for="user in users" :key="user.email">
                    <span>{{ user.username }}</span>
